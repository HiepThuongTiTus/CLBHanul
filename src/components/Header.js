      ...
      <div className='container'>
        ...
        >
          <ul className='nav navbar-nav navbar-right'>
            ...
            <a href="/login" className='page-scroll'> ĐĂNG NHẬP</a>
          )}
            </li>
            <li>
              <a href='#team'>
              {helpers.getTokenLocalStorage() !== null && (
            <a href="/"  className='page-scroll' onClick={() => logoutMovies()}>
              ĐĂNG XUẤT
            </a>
          )}
              </a>
            ...
            <li>
            <a href="https://forms.office.com/r/9ZYxp4jSaS" className='page-scroll'>ĐĂNG KÝ</a>
